...
const sections = [
  ...
  ['Sharing, advertising and analytics', 'Netora shows advertisements through Google AdMob in banner, native and interstitial formats. To serve and measure ads, Google AdMob may access your device advertising ID, IP address and coarse ad-request signals. Netora does not store this information and does not operate its own analytics or tracking SDK. Interstitial ads appear only after a completed speed test, with a frequency cap, and never while a test is running, while offline or on error. In the EEA, UK and other regulated regions, Netora presents a Google User Messaging Platform consent form before requesting ads; without consent, only non-personalized ads are requested. Netora does not sell personal information. External infrastructure providers necessarily receive your public IP and standard request metadata when your device contacts their service; their handling is governed by their own policies.'],
  ...
  ['Contact', 'For privacy questions or support, contact support@xyteee.com or view the full policy at https://xyteee.com/netora/privacy-policy. Developer: XYTEEE.'],
] as const;
